...
async def handle_task(
    ...
    orchestration: Annotated[OrchestrationService, Depends(get_orchestration)],
) -> TaskResponse:
    """
    ...
    Args:
        ...
        orchestration (OrchestrationService): Injected dependency for triggering subsequent stages.
    ...
    try:
        ...
        # ExecutionService via `Depends()` in the route signature?
        #
        # Because ExecutionService requires `job_id` and a dynamic API key to be built.
        ...
        # of wiring, keeping the ExecutionService itself pure.
        # ==============================================================================
