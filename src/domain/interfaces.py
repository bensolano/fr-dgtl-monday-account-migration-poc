...
from src.domain.models import JobDocument, MigrationDag, TaskPayload
from src.infrastructure.monday.rate_limit import TokenBucketResult
...
# Our concrete classes (ClassificationService, ReportService) DO NOT need to inherit
...
#
# This allows complete decoupling: JobService only knows about these "shapes"
