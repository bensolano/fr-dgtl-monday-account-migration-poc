...
class ReportEngine:
    ...
    def generate_markdown_report(
        ...
        lines.extend(
            [
                "",
                "## 4. Appendix: Migration Capability Matrix",
                "",
                "This static matrix defines what can and cannot be migrated automatically via the API.",
                "",
                "### Fully Migratable (Full Auto)",
                "- **Workspaces & Boards:** Core structure and settings.",
                "- **Groups & Items:** All standard items and their grouping.",
                "- **Native Columns:** Text, numbers, status, date, people, dropdown, checkbox, timeline.",
                "- **Subitems:** Completely supported (requires explicit traversal).",
                "- **Docs & Articles:** Content structure is fully cloned.",
                "- **Connect-Boards & Mirrors:** Supported, but order-dependent.",
                "",
                "### Partially Migratable (w/ Caveats)",
                "- **Updates / Comments:** Copied, but original author/timestamp is lost (replaced with API user/now).",
                "- **Files / Attachments:** Supported via binary transfer, but very heavy on API quotas.",
                "- **Formula Columns:** Formula string is copied, but may break if connected boards are out of scope.",
                "",
                "### Manual Only (Not Supported via API)",
                "- **Automations / Integration Recipes:** Cannot be read or written via API.",
                "- **Dashboards:** Cross-board widget configurations are not exposed.",
                "- **Permissions:** Board and column restrictions cannot be scripted.",
                "- **Custom Views & Forms:** UI-only features.",
                "- **User Identity:** You can invite users, but cannot recreate their exact identity/profile.",
                "",
                "---",
